Pod::Spec.new do |s|
  ...
  s.source = { :http => 'https://fritz-swift-sdk-release-production.s3.amazonaws.com/FritzVisionLivingRoomSegmentationModelAccurate/5.0.1/FritzVisionLivingRoomSegmentationModelAccurate.zip' }
  s.requires_arc = true
