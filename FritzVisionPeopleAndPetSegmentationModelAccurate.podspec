Pod::Spec.new do |s|
  ...
  s.source = { :http => 'https://fritz-swift-sdk-release-production.s3.amazonaws.com/FritzVisionPeopleAndPetSegmentationModelAccurate/6.1.1/FritzVisionPeopleAndPetSegmentationModelAccurate.zip' }
  s.requires_arc = true
