Pod::Spec.new do |s|
  ...
  s.source = { :http => 'https://fritz-swift-sdk-release-production.s3.amazonaws.com/FritzVisionStyleModelPaintings/6.0.0-beta.3/FritzVisionStyleModelPaintings.zip' }
  s.requires_arc = true
