Pod::Spec.new do |s|
  ...
  s.source = { :http => 'https://fritz-swift-sdk-release-production.s3.amazonaws.com/FritzVisionLivingRoomSegmentationModelSmall/6.0.0-beta.2/FritzVisionLivingRoomSegmentationModelSmall.zip' }
  s.requires_arc = true
