Pod::Spec.new do |s|
  ...
  s.source = { :http => 'https://fritz-swift-sdk-release-production.s3.amazonaws.com/FritzVisionLivingRoomSegmentationModelSmall/5.3.0/FritzVisionLivingRoomSegmentationModelSmall.zip' }
  s.requires_arc = true
