Pod::Spec.new do |s|
  ...
  s.source = { :http => 'https://fritz-swift-sdk-release-production.s3.amazonaws.com/FritzVisionPetSegmentationModelSmall/5.2.0/FritzVisionPetSegmentationModelSmall.zip' }
  s.requires_arc = true
