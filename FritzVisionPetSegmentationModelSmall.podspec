Pod::Spec.new do |s|
  ...
  s.source = { :http => 'https://fritz-swift-sdk-release-production.s3.amazonaws.com/FritzVisionPetSegmentationModelSmall/6.1.2/FritzVisionPetSegmentationModelSmall.zip' }
  s.requires_arc = true
