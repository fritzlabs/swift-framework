Pod::Spec.new do |s|
  ...
  s.subspec 'ManagedModel' do |analytics|
    analytics.dependency 'FritzBase/Core', '3.6.0'
  ...
  s.subspec 'CoreMLHelpers' do |helpers|
    helpers.vendored_framework = 'Frameworks/CoreMLHelpers.framework', '3.6.0'
  end

  s.subspec 'Vision' do |helpers|
    helpers.dependency 'FritzBase/Core', '3.6.0'
    helpers.dependency 'FritzBase/CoreMLHelpers', '3.6.0'
    helpers.dependency 'FritzBase/ManagedModel', '3.6.0'
