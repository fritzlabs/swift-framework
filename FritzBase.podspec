Pod::Spec.new do |s|
  ...
  s.source = { :http => 'https://fritz-swift-sdk-release-production.s3.amazonaws.com/FritzBase/6.0.0-beta.2/FritzBase.zip' }
  ...
  s.subspec 'ManagedModel' do |analytics|
    analytics.dependency 'FritzBase/Core', '6.0.0-beta.2'
  ...
  s.subspec 'CoreMLHelpers' do |helpers|
    helpers.vendored_framework = 'Frameworks/CoreMLHelpers.framework', '6.0.0-beta.2'
  end

  s.subspec 'Vision' do |helpers|
    helpers.dependency 'FritzBase/Core', '6.0.0-beta.2'
    helpers.dependency 'FritzBase/CoreMLHelpers', '6.0.0-beta.2'
    helpers.dependency 'FritzBase/ManagedModel', '6.0.0-beta.2'
