Pod::Spec.new do |s|
  ...
  s.subspec 'ManagedModel' do |analytics|
    analytics.dependency 'FritzBase/Core', '3.7.0-beta.2'
  ...
  s.subspec 'CoreMLHelpers' do |helpers|
    helpers.vendored_framework = 'Frameworks/CoreMLHelpers.framework', '3.7.0-beta.2'
  end

  s.subspec 'Vision' do |helpers|
    helpers.dependency 'FritzBase/Core', '3.7.0-beta.2'
    helpers.dependency 'FritzBase/CoreMLHelpers', '3.7.0-beta.2'
    helpers.dependency 'FritzBase/ManagedModel', '3.7.0-beta.2'
