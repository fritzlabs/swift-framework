Pod::Spec.new do |s|
  ...
  s.source = { :http => 'https://github.com/fritzlabs/swift-framework/releases/download/4.2.3/FritzBase.zip' }
  ...
  s.subspec 'ManagedModel' do |analytics|
    analytics.dependency 'FritzBase/Core', '4.2.3'
  ...
  s.subspec 'CoreMLHelpers' do |helpers|
    helpers.vendored_framework = 'Frameworks/CoreMLHelpers.framework', '4.2.3'
  end

  s.subspec 'Vision' do |helpers|
    helpers.dependency 'FritzBase/Core', '4.2.3'
    helpers.dependency 'FritzBase/CoreMLHelpers', '4.2.3'
    helpers.dependency 'FritzBase/ManagedModel', '4.2.3'
