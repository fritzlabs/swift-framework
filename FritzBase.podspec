Pod::Spec.new do |s|
  ...
  s.subspec 'ManagedModel' do |analytics|
    analytics.dependency 'FritzBase/Core', '5.0.3'
  ...
  s.subspec 'CoreMLHelpers' do |helpers|
    helpers.vendored_framework = 'Frameworks/CoreMLHelpers.framework', '5.0.3'
  end

  s.subspec 'Vision' do |helpers|
    helpers.dependency 'FritzBase/Core', '5.0.3'
    helpers.dependency 'FritzBase/CoreMLHelpers', '5.0.3'
    helpers.dependency 'FritzBase/ManagedModel', '5.0.3'
