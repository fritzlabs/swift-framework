Pod::Spec.new do |s|
  ...
  s.subspec 'ManagedModel' do |analytics|
    analytics.dependency 'FritzBase/Core', '6.0.0-beta.3'
  ...
  s.subspec 'CoreMLHelpers' do |helpers|
    helpers.vendored_framework = 'Frameworks/CoreMLHelpers.framework', '6.0.0-beta.3'
  end

  s.subspec 'Vision' do |helpers|
    helpers.dependency 'FritzBase/Core', '6.0.0-beta.3'
    helpers.dependency 'FritzBase/CoreMLHelpers', '6.0.0-beta.3'
    helpers.dependency 'FritzBase/ManagedModel', '6.0.0-beta.3'
