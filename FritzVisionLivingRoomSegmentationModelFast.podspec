Pod::Spec.new do |s|
  ...
  s.source = { :http => 'https://fritz-swift-sdk-release-production.s3.amazonaws.com/FritzVisionLivingRoomSegmentationModelFast/5.0.0-beta.1/FritzVisionLivingRoomSegmentationModelFast.zip' }
  s.requires_arc = true
