Pod::Spec.new do |s|
  ...
  s.source = { :http => 'https://fritz-swift-sdk-release-production.s3.amazonaws.com/FritzVisionLivingRoomSegmentationModelFast/5.2.0/FritzVisionLivingRoomSegmentationModelFast.zip' }
  s.requires_arc = true
