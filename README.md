Fritz SDK for Swift and Objective-C
===================================
...
This repository contains all the iOS Frameworks that comprise of Fritz iOS SDK. The SDK can also be installed using Cocoapods. See [releases](https://github.com/fritzlabs/swift-framework/releases) for the latest update to the Fritz SDK. 
