...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="FritzVisionPeopleSegmentationModelBase",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
+ (void)setWifiRequiredForModelDownload:(BOOL)newValue;
...
@interface FritzVisionPeopleSegmentationModel (SWIFT_EXTENSION(FritzVisionPeopleSegmentationModelBase))
