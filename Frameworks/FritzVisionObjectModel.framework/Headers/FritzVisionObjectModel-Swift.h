...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="FritzVisionObjectModel",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
///
- (void)fritzImage:(FritzVisionImage * _Nonnull)fritzImage options:(FritzVisionObjectModelOptions * _Nonnull)options completion:(void (^ _Nonnull)(NSArray<FritzVisionObject *> * _Nullable, NSError * _Nullable))completion;
@end
