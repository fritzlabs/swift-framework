...
#ifndef FRITZVISIONPEOPLESEGMENTATIONMODELFAST_SWIFT_H
#define FRITZVISIONPEOPLESEGMENTATIONMODELFAST_SWIFT_H
...
@class FritzVisionPeopleSegmentationModelFast;

SWIFT_CLASS_NAMED("FritzVisionPeopleSegmentationModelFastObjc") SWIFT_AVAILABILITY(ios,introduced=12.0)
