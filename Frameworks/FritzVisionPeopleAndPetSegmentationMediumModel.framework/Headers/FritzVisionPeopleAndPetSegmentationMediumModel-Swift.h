...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="FritzVisionPeopleAndPetSegmentationMediumModel",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS_NAMED("FritzVisionPeopleAndPetSegmentationMediumClass")
...
SWIFT_CLASS_NAMED("FritzVisionPeopleAndPetSegmentationMediumModel") SWIFT_AVAILABILITY(ios,introduced=11.0)
...
///
+ (void)fetchModelWithCompletionHandler:(void (^ _Nonnull)(FritzVisionPeopleAndPetSegmentationMediumModel * _Nullable, NSError * _Nullable))completionHandler;
...
@interface FritzVisionPeopleAndPetSegmentationMediumModel (SWIFT_EXTENSION(FritzVisionPeopleAndPetSegmentationMediumModel))
