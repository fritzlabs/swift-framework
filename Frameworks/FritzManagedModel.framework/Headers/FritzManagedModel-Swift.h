...
SWIFT_MODULE_NAMESPACE_PUSH("FritzManagedModel")
@class MLModel;
...
@interface FritzEnvironment (SWIFT_EXTENSION(FritzManagedModel))
/// Default environment
...
@interface NSNotification (SWIFT_EXTENSION(FritzManagedModel))
