Pod::Spec.new do |s|
  ...
  s.source = { :http => 'https://fritz-swift-sdk-release-production.s3.amazonaws.com/FritzVisionSkySegmentationModelSmall/5.1.0/FritzVisionSkySegmentationModelSmall.zip' }
  s.requires_arc = true
