Pod::Spec.new do |s|
  ...
  s.source = { :http => 'https://fritz-swift-sdk-release-production.s3.amazonaws.com/FritzVisionSkySegmentationModelSmall/5.2.1/FritzVisionSkySegmentationModelSmall.zip' }
  s.requires_arc = true
