Pod::Spec.new do |s|
  ...
  s.source = { :http => 'https://fritz-swift-sdk-release-production.s3.amazonaws.com/FritzVisionSkySegmentationModelSmall/5.2.0/FritzVisionSkySegmentationModelSmall.zip' }
  s.requires_arc = true
