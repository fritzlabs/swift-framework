Pod::Spec.new do |s|
  ...
  s.source = { :http => 'https://fritz-swift-sdk-release-production.s3.amazonaws.com/FritzVisionSkySegmentationModelSmall/6.0.0-beta.1/FritzVisionSkySegmentationModelSmall.zip' }
  s.requires_arc = true
