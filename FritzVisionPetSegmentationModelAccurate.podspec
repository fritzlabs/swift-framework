Pod::Spec.new do |s|
  ...
  s.source = { :http => 'https://fritz-swift-sdk-release-production.s3.amazonaws.com/FritzVisionPetSegmentationModelAccurate/5.0.0-beta.4/FritzVisionPetSegmentationModelAccurate.zip' }
  s.requires_arc = true
