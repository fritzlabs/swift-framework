Pod::Spec.new do |s|
  ...
  s.source = { :http => 'https://fritz-swift-sdk-release-production.s3.amazonaws.com/FritzVisionPetSegmentationModelAccurate/5.3.0/FritzVisionPetSegmentationModelAccurate.zip' }
  s.requires_arc = true
