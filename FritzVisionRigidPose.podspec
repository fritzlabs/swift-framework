Pod::Spec.new do |s|
  ...
  s.source = { :http => 'https://github.com/fritzlabs/swift-framework/releases/download/3.5.0-beta.1/FritzVisionRigidPose.zip' }
  ...
  s.dependency 'FritzBase/Vision', '3.5.0-beta.1'
