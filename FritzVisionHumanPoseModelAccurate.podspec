Pod::Spec.new do |s|
  ...
  s.source = { :http => 'https://fritz-swift-sdk-release-production.s3.amazonaws.com/FritzVisionHumanPoseModelAccurate/6.1.2-beta.3/FritzVisionHumanPoseModelAccurate.zip' }
  s.requires_arc = true
