Pod::Spec.new do |s|
  ...
  s.source = { :http => 'https://fritz-swift-sdk-release-production.s3.amazonaws.com/FritzVisionHumanPoseModelAccurate/5.0.0-beta.1/FritzVisionHumanPoseModelAccurate.zip' }
