Pod::Spec.new do |s|
  ...
  s.source = { :http => 'https://fritz-swift-sdk-release-production.s3.amazonaws.com/FritzVisionSkySegmentationModelFast/6.1.2-beta.2/FritzVisionSkySegmentationModelFast.zip' }
  s.requires_arc = true
