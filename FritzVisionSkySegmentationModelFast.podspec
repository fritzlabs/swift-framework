Pod::Spec.new do |s|
  ...
  s.source = { :http => 'https://fritz-swift-sdk-release-production.s3.amazonaws.com/FritzVisionSkySegmentationModelFast/5.0.0-beta.4/FritzVisionSkySegmentationModelFast.zip' }
  s.requires_arc = true
