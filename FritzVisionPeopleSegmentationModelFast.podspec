Pod::Spec.new do |s|
  ...
  s.source = { :http => 'https://fritz-swift-sdk-release-production.s3.amazonaws.com/FritzVisionPeopleSegmentationModelFast/5.0.0-beta.1/FritzVisionPeopleSegmentationModelFast.zip' }
  s.requires_arc = true
