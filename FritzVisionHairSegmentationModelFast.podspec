Pod::Spec.new do |s|
  ...
  s.source = { :http => 'https://fritz-swift-sdk-release-production.s3.amazonaws.com/FritzVisionHairSegmentationModelFast/5.1.0/FritzVisionHairSegmentationModelFast.zip' }
  s.requires_arc = true
