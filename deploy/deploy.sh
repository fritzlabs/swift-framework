...
aws s3 cp /docs/ s3://${S3_BUCKET}/iOS/${CI_BRANCH}/  --recursive
...
aws s3 cp /tmp/index.html s3://${S3_BUCKET}/iOS/index.html
aws s3 cp /tmp/index.html s3://${S3_BUCKET}/iOS/latest/index.html
