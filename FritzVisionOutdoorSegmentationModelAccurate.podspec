Pod::Spec.new do |s|
  ...
  s.source = { :http => 'https://fritz-swift-sdk-release-production.s3.amazonaws.com/FritzVisionOutdoorSegmentationModelAccurate/5.0.0/FritzVisionOutdoorSegmentationModelAccurate.zip' }
  s.requires_arc = true
